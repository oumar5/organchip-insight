...
| P1 | **fait localement** : vue « Comparaison des moteurs » alimentée par trois rapports versionnés (`reports/benchmarks/*.json`) : F1/IoU, intervalles, coût CPU, mémoire, décision et hashes ; les overlays d'erreur sont produits par les benchmarks mais ne sont pas embarqués dans l'interface | générateur déterministe, test Playwright, [REX](retours-experience/2026-09-17-comparaison-moteurs.md), aucun chiffre saisi à la main |

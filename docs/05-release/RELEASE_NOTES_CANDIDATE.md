# OrganChip Insight — AI4S v1.0.0 release notes

Tag: **`v1.0.0-ai4s`**<br>
Release branch: **`main`**<br>
Validated source: resolve the immutable commit from this release tag.<br>
Release date: **18 September 2026**

This public release is the reproducible source package submitted by Ben Lol
OUMAR as a solo team. Project code is Apache-2.0.
...
No ONNX, PyTorch or µSAM weight file is distributed in this release. A later

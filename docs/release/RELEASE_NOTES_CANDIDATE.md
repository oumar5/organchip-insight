...
- release audit: 250 tracked files, zero violations at candidate validation;
- release inventory: 38 SHA-256 entries;
- technical report: deterministic 15-page A4 PDF;
- demo: 198 seconds, 1280×720, H.264/AAC, seven English caption scenes.
...
- `docs/release/release-checksums.sha256`
...
- `output/video/organchip-insight-demo-candidate.mp4`

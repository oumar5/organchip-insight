...
Le script `backend/evaluation/build_benchmark_summary.py` lit trois rapports
versionnés :
...
(instances nucléaires sur un sous-ensemble pré-enregistré de 12 images). Les
scores ne sont jamais comparés entre ces deux jeux.

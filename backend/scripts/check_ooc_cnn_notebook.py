...
def check_notebook(path: Path) -> None:
    ...
    _require(
        ...
        (
            ...
            'FINAL_EVAL_REASON = ""',
            'SOURCE_INPUT_DIR = Path("/kaggle/input/datasets/oumarbenlol/',
            "organchip-insight-source-campaign-v2/organchip-insight",
            'SOURCE_MANIFEST_PATH = SOURCE_INPUT_DIR.parent / "source-bundle-manifest.json"',
            "EXPECTED_SOURCE_BUNDLE_SHA256",
            'TRAIN_VALIDATION_IMAGE_ROOT = Path("/kaggle/input/datasets/oumarbenlol/',
            "organchip-train-validation-v2/train-validation/images",
            'WEIGHTS_INPUT_DIR = Path("/kaggle/input/datasets/oumarbenlol/',
